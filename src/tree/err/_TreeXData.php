...
class _TreeXData extends XDataAbstract
{
    ...
    public function getXMessageTemplates(): array
    {
        return [
            ...
            InvalidDepthFirstSearchOrderingException::class => 'oredering value must be the PREORDER or POSTORDER class consant.',
            InvalidNodeIdException::class => 'Invalid nodeid ${nodeid} - must be an integer >= 0.',
            InvalidValueException::class => 'Invalid node value.',
            ...
            NoRootFoundException::class => 'no root node found in tree node value object array.',
