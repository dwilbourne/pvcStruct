 ...
 * @extends TreeAbstract<TreenodeInterface, NodeValueType>
...
class Tree extends TreeAbstract implements TreeInterface
{
    ...
    {
        /**
         * This seems like a waste, except that the add method for TreeOrdered also uses addNodeToNodelistAndSetRoot
         * and then does some more stuff.  So the common code between the two classes is shared in the
         * addNodeToNodelistAndSetRoot method kept in TreeAbstract
         */
     ...
     * populated and valid.
     *
     * @param TreenodeInterface<NodeValueType>[] $nodeArray .  $nodeArray must have the form $nodeid => $node for each
     * element. The $nodeid key is used to insure all nodeid's are unique and to (easily) verify that each non-null
     * parentid has a corresponding node in the tree.  This method is used to hydrate the tree in one step.  Thus, the
     * tree must have no nodes in it in order to use this method successfully.
     * @throws AlreadySetRootException
    ...
    {
        /**
         * This seems like a waste, except that the add method for TreeOrdered also uses addNodesToNodelistAndSetRoot
         * and then does some more stuff so the common code between the two classes is shared in the
         * addNodeToNodelistAndSetRoot method kept in TreeAbstract
         */
