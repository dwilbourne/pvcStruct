...
/**
 * Class NodeTypeUnorderedFactory
 */
class NodeTypeUnorderedFactory implements NodeTypeFactoryInterface
{
    ...
    public function makeNodeType(
        ...
        return new TreenodeUnordered($nodeId, $parentId, $treeId, $tree, $collectionAbstract);
    }
}
