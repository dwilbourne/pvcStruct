...
class TreeDefinitionsTest extends TestCase
{
    ...
    public function testSetUp(): void
    {
        ...
        self::assertInstanceOf(
            ...
            $this->container->get(IndexedCollection::class)
        );
        self::assertInstanceOf(
            CollectionOrderedByIndexFactoryInterface::class,
            $this->container->get(IndexedCollectionFactory::class)
        );

        self::assertInstanceOf(
            TreenodeChildCollectionInterface::class,
            $this->container->get(TreenodeCollection::class)
        );

        self::assertInstanceOf(
            TreenodeChildCollectionFactoryInterface::class,
            $this->container->get(ChildCollectionFactory::class)
        );
